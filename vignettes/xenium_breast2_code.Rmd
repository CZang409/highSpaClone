---
title: "Xenium Breast Cancer Dataset 2"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Xenium Breast Cancer Dataset 2}
...
```{r}
# apply highSpaClone to infer spatial CNA and detect tumor subclones
...
# CNA inference and subclone detection
cna_obj <- FindClone(smooth_obj,
...
spatialplot(cna_obj, colors=colors, point_size = 0.05)

# CNA heatmap
log.cna <- log2(cna_obj@cna.data)
log.cna[log.cna > -0.3 & log.cna < 0.3] <- 0

xenium_breast2 <- list(
  cna.data   = log.cna,
  annotation = cna_obj@cluster,
  chr_pos    = cna_obj@chr_pos
)

cna_heatmap(
  cna.obj=xenium_breast2,
  groupby = "cell.label",
  min_value  = -2.5,  
  max_value  = 2.5,
  auto_size = F,
